                                    ...
                                    <div className="form-group row">
                                        <div className="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" className="form-control" id="exampleProductName"
                                                placeholder="FirProduct Name" onChange={(e) => onFormChange("productname", e.target.value)}/>
                                        </div>
                                        <div className="col-sm-6">
                                            <input type="text" className="form-control" id="exampleProductImage"
                                                placeholder="Product Image" onChange={(e) => onFormChange("productimage", e.target.value)}/>
                                        </div>
                                    </div>
