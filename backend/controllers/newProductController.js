...
//     const { productname, price, productimage, quantity } = req.body;
...
//             const ImgId = currentProduct.productimage.public_id;
//             if (ImgId) {
//                 await cloudinary.uploader.destroy(ImgId);
//             }

//             const newImage = await cloudinary.uploader.upload(req.body.productimage, {
//                 folder: "productphotos",
//                 width: 1000,
//                 crop: "scale"
//             });
